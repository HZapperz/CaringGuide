          ...
          <div className="bg-white shadow-lg rounded-lg overflow-hidden">
            ...
            <div className="p-4">
              ...
              <p className="text-gray-700 text-base">
                ...
                That&apos;s why all of our guides go through a rigorous
                verification process before they are officially approved. This
                includes background checks, reference checks, and personal
                interviews. You can rest assured that you&apos;re in good hands
                with Caring Guide.
              </p>
            </div>
          </div>
          ...
          <div className="bg-white shadow-lg rounded-lg overflow-hidden">
            ...
            <div className="p-4">
              ...
              <p className="text-gray-700 text-base">
                ...
                overwhelming and stressful. That&apos;s why we connect
                caregivers with a personal mentor who provides emotional and
                practical support throughout their caregiving journey.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="grid grid-cols-2 ">
            <div className="bg-caring px-4 py-6 flex-1">
              ...
              <h2 className="text-2xl font-bold text-black">
                41.8 million Americans provided care to an adult over 50 in 2020
              </h2>
            </div>
            <div className="bg-caring px-4 py-6 flex-1">
              <hr className="w-48 h-1 mx-auto bg-gray-100 border-0 rounded ml-8 mb-4" />
              <h2 className="text-2xl font-bold bg text-black">
                89% of caregivers provide care for a relative or other loved one
              </h2>
            </div>
            <div className="bg-caring px-4 py-6 flex-1">
              <hr className="w-48 h-1 mx-auto bg-gray-100 border-0 rounded ml-8 mb-4" />
              <h2 className="text-2xl font-bold text-black ">
                16.6% of Americans provide care to adults with a disability or
                illness
              </h2>
            </div>
            <div className="bg-caring px-4 py-6 flex-1">
              <hr className="w-48 h-1 mx-auto bg-gray-100 border-0 rounded ml-8 mb-4" />
              <h2 className="text-2xl font-bold text-black">
                23.7 hours per week on average spent providing care for loved
                ones not lived with
              </h2>
            </div>
          </div>
